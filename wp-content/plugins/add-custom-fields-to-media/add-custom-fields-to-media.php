...
function thisismyurl_add_custom_media_fields_do_page()
{
    ...
    <div class="wrap">
        ...
        <form method="post" action="options-general.php?page=thisismyurl_add_custom_media_fields">
                ...
                <table class="form-table">
                    ...
                    <?php foreach ($media_custom_fields as $custom_field) { ?>
                        <tr valign="top">
                            ...
                            <td>
                                <a href='options-general.php?page=thisismyurl_add_custom_media_fields&delete=<?php echo urlencode($custom_field['unique_id']); ?>'>x</a>
                            </td>
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="text" name="unique_id" id="unique_id"
                               value=""><br><em><?php _e('Unique field names may not include spaces or special characters and should be lowercase. For example my_unique_id', 'thisismyurl_add_custom_media_fields'); ?></em>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Field Title', 'thisismyurl_add_custom_media_fields'); ?></th>
                    <td><input type="text" name="field_title" id="field_title"
                               value=""><br><em><?php _e('The field title, as displayed to users during media uploads.', 'thisismyurl_add_custom_media_fields'); ?></em>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Field Help', 'thisismyurl_add_custom_media_fields'); ?></th>
                    <td><input type="text" name="field_help" id="field_help"
                               value=""><br><em><?php _e('Helpful tips, displayed to users during media uploads.', 'thisismyurl_add_custom_media_fields'); ?></em>
                    </td>
                </tr>
        ...
        <ul>
            <li>
                <a href="https://github.com/thisismyurl/Add-Custom-Fields-to-Media/issues"><?php _e('Report a bug, or suggest an improvement.'); ?></a>
            </li>
