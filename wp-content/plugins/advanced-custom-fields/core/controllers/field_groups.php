            ...
            <div id="acf-about" class="acf-content">
                ...
                <div class="acf-content-title">
                    ...
                    <h2><?php _e("Thank you for updating to the latest version!", 'acf'); ?>
                        <br/><?php printf(__('ACF %s is more polished and enjoyable than ever before. We hope you like it.', 'acf'), $version); ?>
                    </h2>
                </div>
                <!-- / acf-content-title -->
                ...
                <div class="acf-content-body">
                    ...
                    <?php if ($tab == 'whats-new'):
                        ...
                        <p><?php _e("Creating your own field type has never been easier! Unfortunately, version 3 field types are not compatible with version 4.", 'acf'); ?>
                            <br/>
                            <?php printf(__('Migrating your field types is easy, please %sfollow this tutorial%s to learn more.', 'acf'), '<a href="http://www.advancedcustomfields.com/docs/tutorials/creating-a-new-field-type/" target="_blank">', '</a>'); ?>
                        </p>
