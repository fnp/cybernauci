...
<tr id="row_<?php echo $name; ?>"
    ...
    switch ($s['type']) {
        case 'text':
            ...
            <input type="text" class="code <?php echo $class; ?>" name="<?php echo $name; ?>" id="<?php echo $name; ?>"
        ...
        case 'number':
            ...
            <input type="number" class="code <?php echo $class; ?>" name="<?php echo $name; ?>"
                   id="<?php echo $name; ?>" value="<?php echo $value; ?>" min="<?php echo $min; ?>"
                   max="<?php echo $max; ?>"/>
            <?php if ($help_text != '') { ?>
            <a href="#" class="tooltip">
                <img id="" class='ninja-forms-help-text' src="<?php echo NINJA_FORMS_URL; ?>images/question-ico.gif"
        ...
        case 'checkbox':
            ...
            <input type="checkbox" name="<?php echo $name; ?>" value="1" <?php checked($value, 1); ?>
                   id="<?php echo $name; ?>" class="<?php echo $class; ?>">
            <?php if ($help_text != '') { ?>
            <a href="#" class="tooltip">
                <img id="" class='ninja-forms-help-text' src="<?php echo NINJA_FORMS_URL; ?>images/question-ico.gif"
                     title="">
        ...
        case 'checkbox_list':
            ...
            if ($select_all) {
                ...
                <label>
                    <input type="checkbox" name="" value="" id="<?php echo $name; ?>_select_all"
                           class="ninja-forms-select-all" title="ninja-forms-<?php echo $name; ?>">
                ...
                if (is_array($s['options']) AND isset($s['options'][0])) {
                    ...
                    <label>
                        <input type="checkbox" class="ninja-forms-<?php echo $name; ?> <?php echo $class; ?>"
                               name="<?php echo $name; ?>[]"
                               value="<?php echo $option_value; ?>" <?php checked(in_array($option_value, $value)); ?>
        ...
        case 'radio':
            if (is_array($s['options']) AND !empty($s['options'])) {
                ...
                <?php foreach ($s['options'] as $option) { ?>
                    <input type="radio" name="<?php echo $name; ?>" value="<?php echo $option['value']; ?>"
                           id="<?php echo $name . "_" . $x; ?>" <?php checked($value, $option['value']); ?>
                           class="<?php echo $class; ?>"> <label
                        for="<?php echo $name . "_" . $x; ?>"><?php echo $option['name']; ?></label>
                    <?php if ($help_text != '') { ?>
                        <a href="#" class="tooltip">
                            <img id="" class='ninja-forms-help-text'
                                 src="<?php echo NINJA_FORMS_URL; ?>images/question-ico.gif" title="">
									    <span>
									        <img class="callout"
                                                 src="<?php echo NINJA_FORMS_URL; ?>images/callout.gif"/>
                                            <?php echo $help_text; ?>
									    </span>
                        </a>
                    <?php } ?>
        ...
        case 'submit':
            ?>
            <input type="submit" name="<?php echo $name; ?>" class="<?php echo $class; ?>"
        ...
        case 'button':
            ...
            ?>
            <input type="button" name="<?php echo $name; ?>" id="<?php echo $name; ?>" class="<?php echo $class; ?>"
                   value="<?php echo $button_text; ?>">
            <?php
            break;
