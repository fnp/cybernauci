...
function nf_tmp_output_templates()
{
    ...
    <script id="nf-tmpl-field-text" type="text/template">
        <input id="nf-field-<%= id %>" name="nf-field-<%= id %>" class="<%= classes %>" type="text" value="<%= value %>"
               placeholder="<%= placeholder %>">
    </script>

    <script id="nf-tmpl-field-email" type="text/template">
        <input id="nf-field-<%= id %>" name="nf-field-<%= id %>" class="<%= classes %>" type="email"
               value="<%= value %>" placeholder="<%= placeholder %>">
    </script>

    <script id="nf-tmpl-field-textarea" type="text/template">
        <textarea id="nf-field-<%= id %>" name="nf-field-<%= id %>" class="<%= classes %>"
    ...
    <script id="nf-tmpl-field-file" type="text/template">
        ...
        <span class="nf-file-input-wrapper">
			...
			<input id="nf-field-<%= id %>" name="nf-field-<%= id %>" class="<%= classes %>" type="file"
                   style="display:none;">
		</span>
    </script>
    ...
    <script id='nf-tmpl-field-radio-option' type='text/template'>
        <li>
            <label><input type="radio" name="nf-field-<%= fieldID %>" class="<%= classes %>" value="<%= value %>" <%= (
                value == currentValue ) ? 'checked="checked"' : '' %>> <%= label %></label>
        </li>
    </script>
    ...
    <script id='nf-tmpl-field-radio-other' type='text/template'>
        <li>
            <label>
                <input type="radio" name="nf-field-<%= fieldID %>" class="<%= classes %>" value="nf-other" <%= (
                currentValue == 'nf-other' ) ? 'checked="checked"' : '' %>>
                Other
            </label>
            <%= renderOtherText() %>
        </li>
