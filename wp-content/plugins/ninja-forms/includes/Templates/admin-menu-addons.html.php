<div class="wrap">
    ...
    <?php foreach ($notices as $notice): ?>
        ...
        <div class="nf-addon-notice">
            <p>
                <strong><?php echo $notice['title']; ?></strong> requires an update. You have version
                <strong><?php echo $notice['old_version']; ?></strong> installed. The current version is
                <strong><?php echo $notice['new_version']; ?></strong>.
            </p>
        </div>
            ...
            <div class="nf-extend-content">
                ...
                <div class="nf-extend-buttons">
                    ...
                    <?php if (!empty($item['docs'])): ?>
                        ...
                        <a href="<?php echo $item['docs']; ?>"
                           class="button-secondary nf-doc-button"><?php _e('Documentation', 'ninja-forms'); ?></a>
                    <?php else: ?>
