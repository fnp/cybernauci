    ...
    <form action="" method="post">
        ...
        <table class="form-table">
                ...
                <td>
                    <ul>
                        <?php foreach ($fields as $field): ?>
                            <li>
                                <input type="checkbox" name="nf_export_fields[]"
                                       value="<?php echo $field->get_id(); ?>">
            ...
            <tr id="row_nf_export_fields_submit">
                ...
                <td>
                    <input type="submit" id="nf_export_fields_submit" class="button-secondary"
                           value="<?php echo __('Export Fields', 'ninja-forms'); ?>">
                </td>
            </tr>
            </tbody>
        </table>
