if (window.jQuery)(function (e) {
    ...
    e.fn.rating = function (t) {
        ...
        e.fn.rating.calls++;
        this.not(".ninja-forms-star-rating-applied").addClass("ninja-forms-star-rating-applied").each(function () {
            var n, r = e(this);
            ...
            if (u && n)n.count++; else {
                n = e.extend({}, t || {}, (e.metadata ? r.metadata() : e.meta ? r.data() : null) || {}, {
                    count: 0,
                    stars: [],
                    inputs: []
                });
                ...
                u.append(n.cancel = e('<div class="rating-cancel"><a title="' + n.cancel + '">' + n.cancelValue + "</a></div>").on("mouseover", function () {
                    e(this).rating("drain");
                    e(this).addClass("ninja-forms-star-rating-cancel-hover")
                }).on("mouseout", function () {
                    e(this).rating("draw");
                    e(this).removeClass("ninja-forms-star-rating-cancel-hover")
                }).on("click", function () {
                    e(this).rating("select")
                }).data("rating", n))
            }
            var a = e('<div role="text" aria-label="' + this.title + '" class="ninja-forms-star-rating rater-' + n.serial + '"><a title="' + (this.title || this.value) + '">' + this.value + "</a></div>");
            u.append(a);
            ...
            if (n.readOnly)a.addClass("ninja-forms-star-rating-readonly"); else a.addClass("ninja-forms-star-rating-live").on("mouseover", function () {
                e(this).rating("fill");
                e(this).rating("focus")
            }).on("mouseout", function () {
                e(this).rating("draw");
    ...
    e.extend(e.fn.rating, {
        calls: 0, focus: function () {
            ...
            this.rating("drain");
            this.prevAll().addBack().filter(".rater-" + e.serial).addClass("ninja-forms-star-rating-hover")
        }, drain: function () {
            var e = this.data("rating");
            if (!e)return this;
            if (e.readOnly)return;
            e.rater.children().filter(".rater-" + e.serial).removeClass("ninja-forms-star-rating-on").removeClass("ninja-forms-star-rating-hover")
        }, draw: function () {
            var t = this.data("rating");
            if (!t)return this;
            this.rating("drain");
            ...
            if (r)r.addClass("ninja-forms-star-rating-on");
            t.cancel[t.readOnly || t.required ? "hide" : "show"]();
            this.siblings()[t.readOnly ? "addClass" : "removeClass"]("ninja-forms-star-rating-readonly")
        }, select: function (t, n) {
    ...
    e(function () {
        e("input[type=radio].ninja-forms-star").rating()
    })
})(jQuery)