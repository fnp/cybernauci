...
<div class="nf-upgrade">
    ...
    <p>Ninja Forms THREE is the most <em>intuitive</em>, <em>powerful</em>, and <em>enjoyable</em> form builder you will
        ever use.</p>
    ...
    <ol>
        <li>
            <p>
                ...
                <br/>We have tested everything we can and consider this release ready, but if you have any issues please
                report them via the "Get Help" item in the "Forms" menu.
            </p>
        </li>
        <li>
            <p>
                <span class="dashicons dashicons-flag"></span><strong>Calculations will not convert.</strong>
                <br/>Any forms with calculations will be converted to Ninja Forms THREE, but calculations within those
                forms will need recreated as a result of our vastly improved calculations system.
            </p>
        </li>
        <li>
            <p>
                <span class="dashicons dashicons-warning"></span><strong>We have resources to help you with the
                    transition to THREE.</strong>
                <br/>The Ninja Forms THREE documentation, development process, FAQ, and more <a
                    href='http://ninjaforms.com/three/'>can be found here.</a>
            </p>
        </li>
    </ol>
    ...
    <script type="text/html" id="tmpl-table">
                        ...
                        <# if( 'checking' == data.step && ! data.readyToConvert ) { #>
                            <tr>
                                <td colspan="2" style="text-align: center;"><span
                                        class="dashicons dashicons-update"></span></td>
                            </tr>
                            <# } #>
        ...
        <# if( 'undefined' != typeof data.showSupportLink && data.showSupportLink ) { #>
            ...
            <# } #>
                ...
                <# if( 'checking' == data.step && data.readyToConvert ) { #>
                    <p class="opt-in">
                        <small>By upgrading to the Ninja Forms <a href="https://ninjaforms.com/three/">THREE Release
                                Candidate</a>,<br/> you allow <a href="http://wpninjas.com/">The WP Ninjas, LLC</a> to
                            track how Ninja Forms is used and help us make the plugin better.
                        </small>
                    </p>
    ...
    <?php //echo $no_issues_detected; ?><!-- &nbsp; <span class="dashicons dashicons-flag"></span> = --><?php //echo $will_need_attention; ?>
    <!---->
    ...
    <!--        </table>-->
    <!---->
    <!--        <button id="goNinjaGo" class="button go-ninja-go">-->
    <?php //echo __( 'Upgrade Forms', 'ninja-forms' ); ?><!--</button>-->
    <!---->
    <!--    </div>-->
    <!---->
    ...
    <!---->
    <!--        <a href="-->
    <?php //echo admin_url( 'admin.php?page=ninja-forms&nf-switcher=upgrade' ); ?><!--" id="goToThree">Go To Three</a>-->
    <!---->
    <!--    </div>-->
