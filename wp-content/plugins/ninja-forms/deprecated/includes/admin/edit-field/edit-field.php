    ...
    <div class="description description-<?php echo $width; ?> <?php echo $type; ?>" id="<?php echo $name; ?>_p">
        ...
        <span class="field-option">
            ...
            switch ($type) {
                ...
                case 'number':
                    ?>
                    <input type="number" class="<?php echo $class; ?>" name="<?php echo $name; ?>"
                ...
                case 'checkbox':
                    ...
                    <label for="<?php echo $id; ?>" id="<?php echo $id; ?>_label">
                        ...
                        <input type="checkbox" value="1" name="<?php echo $name; ?>" id="<?php echo $id; ?>"
                               class="<?php echo $class; ?>" <?php checked($value, 1); ?>>
                ...
                case 'multi':
                    ?>
                    <select multiple="multiple" id="<?php echo $id; ?>" name="<?php echo $name; ?>"
                ...
                case 'textarea':
                    ?>
                    <textarea id="<?php echo $id; ?>" name="<?php echo $name; ?>" class="<?php echo $class; ?>" rows="3"
                              cols="20"><?php echo $value; ?></textarea>
                    <?php
                    break;
                case 'hidden':
                    ?>
                ...
                case 'desc':
                    ?>
                    <span class="desc"><label for="<?php echo $id; ?>"
                                              id="<?php echo $id; ?>_label"><?php _e($label, 'ninja-forms'); ?></label></span>
                    <?php
                    break;
                case 'rte':
