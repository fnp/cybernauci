...
class NF_Convert_Forms_Reset
{
    ...
    public function display_advanced_settings()
    {
        ...
        ?>
        <a href="#"
           class="button-primary nf-reset-form-conversion"><?php _e('Reset Form Conversion', 'ninja-forms'); ?></a>
        <p class="description">
        ...
        <div id="nf-conversion-reset-buttons">
            ...
            <div id="nf-admin-modal-update">
                <a class="button-primary"
                   href="<?php echo site_url('wp-admin/index.php?page=ninja-forms-conversion-reset'); ?>"><?php _e('Continue', 'ninja-forms'); ?></a>
            </div>
        </div>
        <?php
    }
