...
class NF_UpgradeHandlerPage
{
    ...
    public function register()
    {
        ...
        /* Parent Slug  */
            NULL,
            /* Page Title   */
            __('Ninja Forms Upgrade', 'ninja-forms'),
            /* Menu Title   */
            __('Upgrade', 'ninja-forms'),
            /* Capabilities */
            apply_filters('ninja_forms_admin_menu_capabilities', 'manage_options'),
            /* Menu Slug    */
            $this->slug,
            /* Function     */
            array($this, 'display')
    ...
    public function scripts()
    {
        ...
        /* Handle       */
            $this->slug,
            /* Source       */
            NF_PLUGIN_URL . 'assets/js/' . $src . '/nf-upgrade-handler' . $suffix . '.js',
            /* Dependencies */
    ...
    public function styles()
    {
        ...
        /* Handle */
            $this->slug,
            /* Source */
            NF_PLUGIN_URL . 'assets/css/nf-upgrade-handler.css'
        );
        ...
        /* Handle */
            'ninja-forms-admin',
            /* Source */
            NF_PLUGIN_URL . 'css/ninja-forms-admin.css'
        );
