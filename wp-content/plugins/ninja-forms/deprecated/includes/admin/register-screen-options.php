    ...
    if (isset($ninja_forms_tabs[$current_page]) AND is_array($ninja_forms_tabs[$current_page])) {
        ...
        <div class="tabs-prefs">
            ...
            foreach ($ninja_forms_tabs[$current_page] as $slug => $tab) {
                ...
                <label for="ninja-forms-tab-<?php echo $slug; ?>"><input class="hide-tab-tog"
                                                                         name="ninja-forms-tab[<?php echo $slug; ?>]"
                                                                         type="checkbox"
                                                                         id="ninja-forms-tab-<?php echo $slug; ?>"
                                                                         value="1" <?php echo $checked; ?> ><?php echo $tab['name']; ?>
                </label>
                <?php
            }
            ?>
        ...
        <?php if (isset($ninja_forms_sidebars[$current_page][$current_tab]) AND is_array($ninja_forms_sidebars[$current_page][$current_tab])) { ?>
            <div class="sidebar-prefs">
                ...
                foreach ($ninja_forms_sidebars[$current_page][$current_tab] as $slug => $sidebar) {
                    ...
                    <label for="ninja-forms-sidebar-<?php echo $slug; ?>"><input class="hide-sidebar-tog"
                                                                                 name="ninja-forms-sidebar[<?php echo $slug; ?>]"
                                                                                 type="checkbox"
                                                                                 id="ninja-forms-sidebar-<?php echo $slug; ?>"
                                                                                 value="1" <?php echo $checked; ?> ><?php echo $sidebar['name']; ?>
                    </label>
                    <?php
                }
                ?>
