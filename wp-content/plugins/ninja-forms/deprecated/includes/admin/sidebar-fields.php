        ...
        foreach ($ninja_forms_fields as $field_slug => $field) {
            if ($field['sidebar'] == $slug) {
                ...
                <p class="button-controls">
                    <a class="button-secondary ninja-forms-new-field" id="<?php _e($field_slug, 'ninja-forms'); ?>"
                       data-limit="<?php echo $limit; ?>" data-type="<?php echo $field_slug; ?>"
                       href="#"><?php _e($field['name'], 'ninja-forms'); ?></a>
                </p>
                <?php
            }
        }
