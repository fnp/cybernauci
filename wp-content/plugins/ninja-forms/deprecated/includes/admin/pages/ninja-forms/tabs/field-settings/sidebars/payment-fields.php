            ...
            if (isset ($data['payment_field_group']) AND $data['payment_field_group'] == 1) {
                ...
                if (isset ($ninja_forms_fields[$type])) {
                    ...
                    <p class="button-controls" id="ninja_forms_insert_def_field_<?php echo $field_id; ?>_p">
                        <a class="button-secondary ninja-forms-insert-def-field"
                           id="ninja_forms_insert_def_field_<?php echo $field_id; ?>" data-limit="<?php echo $limit; ?>"
                           data-field="<?php echo $field_id; ?>" data-type="<?php echo $type; ?>" href="#"
