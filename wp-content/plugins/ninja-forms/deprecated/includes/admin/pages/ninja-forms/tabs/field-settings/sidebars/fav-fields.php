    ...
    if (is_array($field_results)) {
        foreach ($field_results as $field) {
            ...
            <p class="button-controls" id="ninja_forms_insert_fav_field_<?php echo $field_id; ?>_p">
                <a class="button-secondary ninja-forms-insert-fav-field"
                   id="ninja_forms_insert_fav_field_<?php echo $field_id; ?>" data-field="<?php echo $field_id; ?>"
                   data-type="fav" href="#"><?php _e($name, 'ninja-forms'); ?></a>
            </p>
            <?php
        }
    }
