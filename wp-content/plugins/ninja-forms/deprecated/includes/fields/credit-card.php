...
function ninja_forms_field_credit_card_display($field_id, $data, $form_id = '')
{
    ...
    if (!in_array('number', $hide_cc_fields)) {
        ?>
        <div class="ninja-forms-credit-card-number label-<?php echo $label_pos; ?> field-wrap">
            <!-- Open Credit Card Wrap -->
            <?php
            ...
            <input type="text" <?php if ($post_field) {
        ...
        <div>
            <div id="ninja_forms_field_credit_card_number_error"
                 class="ninja-forms-credit-card-number-error ninja-forms-field-error">
                <?php
    ...
    if (!in_array('name', $hide_cc_fields)) {
        ...
        <div class="ninja-forms-credit-card-name label-<?php echo $label_pos; ?> field-wrap">
            <!-- [open_nameoncard_wrap] -->
            <?php
            if ($desc_pos == 'before_label' or $desc_pos == 'before_everything') {
                ?>
            ...
            } ?> class="ninja-forms-field card-name" value="<?php echo $name; ?>">
    ...
    if (!in_array('expires', $hide_cc_fields)) {
        ...
        ?>
        <div class="ninja-forms-credit-card-exp-month label-<?php echo $label_pos; ?> field-wrap">
            <!-- [open_expires_wrap] -->
            <?php
            if ($desc_pos == 'before_label' or $desc_pos == 'before_everything') {
                ?>
            ...
            } ?> class="ninja-forms-field ninja-forms-mask card-expiry-month" data-mask="99"
                   value="<?php echo $expiry_month; ?>">
        ...
        <div class="ninja-forms-credit-card-exp-year label-<?php echo $label_pos; ?> field-wrap">
            <!-- [open_exp_year_wrap] -->
            <?php
            if ($desc_pos == 'before_label' or $desc_pos == 'before_everything') {
                ?>
            ...
            } ?> class="ninja-forms-field ninja-forms-mask card-expiry-year" data-mask="9999"
                   value="<?php echo $expiry_year; ?>">
