...
function ninja_forms_field_profile_pass_display($field_id, $data, $form_id = '')
{
    ...
    if ($reg_password == 1) {
        ?>
        <input id="pass1_<?php echo $field_id; ?>" title="" name="ninja_forms_field_<?php echo $field_id; ?>"
               type="password" class="<?php echo $field_class; ?> pass1" value="<?php echo $default_value; ?>"
        ...
        ?>
        <input id="pass2_<?php echo $field_id; ?>" title="" name="_pass_<?php echo $field_id; ?>" type="password"
               class="<?php echo $field_class; ?> pass2" value="<?php echo $default_value_re; ?>"/>
        <?php
        ...
        ?>
        <input id="ninja_forms_field_<?php echo $field_id; ?>" title=""
               name="ninja_forms_field_<?php echo $field_id; ?>" type="password" class="<?php echo $field_class; ?>"
               value="<?php echo $default_value; ?>" rel="<?php echo $field_id; ?>"/></div>
        <?php
    }
}
