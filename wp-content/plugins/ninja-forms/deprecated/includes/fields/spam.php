...
function ninja_forms_field_spam_edit($field_id, $data)
{
    ...
    <p class="description description-wide">
        <label for="">
            ...
            <input type="text" class="widefat code ninja-forms-field-label"
                   name="ninja_forms_field_<?php echo $field_id; ?>[label]"
                   id="ninja_forms_field_<?php echo $field_id; ?>_label" value="<?php echo stripslashes($question); ?>">
        </label>
    </p>
    <p class="description description-wide">
        <label for="">
            <?php _e('Spam Answer', 'ninja-forms'); ?><br/>
            <input type="text" class="widefat" name="ninja_forms_field_<?php echo $field_id; ?>[answer]" id=""
