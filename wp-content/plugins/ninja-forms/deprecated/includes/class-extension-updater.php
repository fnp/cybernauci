...
class NF_Extension_Updater
{
    ...
    public function output_field($form_id, $data, $field)
    {
        ...
        if ($valid) {
            ...
            <input type="submit" class="button-secondary" name="deactivate_license_<?php echo $this->product_name; ?>"
                   value="<?php _e('Deactivate License', 'ninja-forms'); ?>">
            <?php
        } else {
            ?>
            <input type="text" style="width:55%" class="code" name="<?php echo $this->product_name . '_license'; ?>"
                   id="" value=""/>
            <?php
        }
    }
