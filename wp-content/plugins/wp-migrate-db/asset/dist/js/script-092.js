(function e(t, n, r) {
  ...
  1: [function (require, module, exports) {
    ...
    var MigrationProgressController = {
      ...
      newMigration: function (settings) {
        ...
        var self = this;
        setTimeout(function () {
          self.migration.$overlay.add(self.migration.$progress).add(self.migration.$proVersion).removeClass(
            'hide').addClass('show');
        ...
        this.migration.model.on('change:activeStage',
          this.migration.fixProgressStageWidthForScrollBar.bind(this.migration));
  ...
  }, {"MigrationProgress-model": 2, "MigrationProgress-utils": 3, "MigrationProgress-view": 4}],
  ...
  }, {"MigrationProgressStage-model": 5}],
  ...
  }, {"./MigrationProgressStage-view.js": 6}],
    ...
    var MigrationProgressStageView = Backbone.View.extend({
      ...
      initTotalProgressElem: function () {
        ...
        this.$totalProgressElem = $('<div class="stage-progress ' + this.model.get('name') + '" />')
          ...
          .append(
            '<span class=tables-complete>0</span> <span class=lowercase >of</span> <span class=tables-total>0</span> ' + this.model.get(
              'strings').items_migrated)
      ...
      updateProgressElem: function () {
        ...
        var sizeDone = wpmdb.functions.convertKBSizeToHRFixed(
          Math.min(this.model.getTotalSizeTransferred(), this.model.get('totalSize')));
      ...
      updateStageTotals: function () {
        ...
        this.$totalProgressElem.find('.size-total').text(
          wpmdb.functions.convertKBSizeToHR(this.model.get('totalSize')));
      },
      ...
      showTruncationNotice: function () {
        ...
        this.$truncationNotice = $(
          '<div class="truncation-notice" >' + wpmdb_strings.progress_items_truncated_msg.replace('%1$s',
            '<span class="hidden-items">' + wpmdb_add_commas(this.queuedElements.length) + '</span>') + '</div>');
      ...
      elemComplete: function (item) {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            $clone.remove();
            this.$itemsContainer.find('.item-progress:not(.clone)').last().after(
              $nextEl.css({height: 'auto', marginBottom: marginBottom}));
          }.bind(this), 250);
      ...
      function create_table_select(tables, table_sizes_hr, selected_tables) {
        ...
        if (0 < tables.length) {
          $.each(tables, function (index, table) {
            ...
            var selected = ' ';
            if (undefined !== selected_tables && null !== selected_tables && 0 < selected_tables.length && -1 !== $.inArray(
                table, selected_tables)) {
              selected = ' selected="selected" ';
            }
            $($table_select).append(
              '<option' + selected + 'value="' + table + '">' + table + ' (' + table_sizes_hr[table] + ')</option>');
          });
        }
      ...
      $(document).ready(function () {
        ...
        max_request_size_slider.slider({
          ...
          create: function (event, ui) {
            ...
            set_slider_value(max_request_size_container, wpmdb_data.max_request / 1024, display_info.unit,
              display_info.amount);
          },
          ...
          stop: function (event, ui) {
            ...
            $('.amount', max_request_size_container).after(
              '<img src="' + spinner_url + '" alt="" class="slider-spinner general-spinner" />');
            ...
            $.ajax({
              ...
              success: function () {
                max_request_size_slider.slider('enable');
                $('.slider-label-wrapper', max_request_size_container).append(
                  '<span class="slider-success-msg">' + wpmdb_strings.saved + '</span>');
          ...
          stop: function (event, ui) {
            ...
            $.ajax({
              ...
              success: function () {
                ...
                delay_between_requests_slider.slider('enable');
                $('.slider-label-wrapper', delay_between_requests_container).append(
                  '<span class="slider-success-msg">' + wpmdb_strings.saved + '</span>');
        ...
        function refresh_table_selects() {
          ...
          if (undefined !== wpmdb.common.connection_data && undefined !== wpmdb.common.connection_data.tables && undefined !== wpmdb.common.connection_data.table_sizes_hr) {
            $pull_select = create_table_select(wpmdb.common.connection_data.tables,
              wpmdb.common.connection_data.table_sizes_hr, $($pull_select).val());
          }
        }
        ...
        function disable_table_migration_options() {
          $('#migrate-selected').parents('.option-section').children('.header-expand-collapse').children(
            '.expand-collapse-arrow').removeClass('collapsed');
        ...
        function establish_remote_connection_from_saved_profile() {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $pull_select = create_table_select(wpmdb.common.connection_data.tables,
                wpmdb.common.connection_data.table_sizes_hr, loaded_tables);
              ...
              $.each(wpmdb.common.connection_data.tables, function (index, value) {
                ...
                $($table_select_backup).append(
                  '<option' + selected + 'value="' + value + '">' + value + ' (' + wpmdb.common.connection_data.table_sizes_hr[value] + ')</option>');
              });
        ...
        function enable_pro_licence(data, licence_key) {
          ...
          $('.support-content').empty().html(
            '<p>' + wpmdb_strings.fetching_license + '<img src="' + spinner_url + '" alt="" class="ajax-spinner general-spinner" /></p>');
        ...
        $('body').on('click', '.register-licence', function (e) {
          ...
          if ('' === licence_key) {
            $licence_status.html(
              '<div class="notification-message error-notice">' + wpmdb_strings.enter_license_key + '</div>');
            return;
          }
          ...
          $('.button.register-licence').after(
            '<img src="' + spinner_url + '" alt="" class="register-licence-ajax-spinner general-spinner" />');
            ...
            success: function (data) {
              ...
              if ('undefined' !== typeof data.errors) {
                ...
                if (1 === Number(data.is_first_activation)) {
                  wpmdb_strings.welcome_text = wpmdb_strings.welcome_text.replace('%1$s',
                    'https://deliciousbrains.com/wp-migrate-db-pro/doc/quick-start-guide/');
                  wpmdb_strings.welcome_text = wpmdb_strings.welcome_text.replace('%2$s',
        ...
        $('.migrate-db-button').click(function (event) {
          ...
          if ('savefile' !== wpmdb_migration_type() && $('#backup-manual-select').is(':checked') && null === $(
              '#select-backup').val()) {
          ...
          $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
              ...
              wpmdb.current_migration.setState(wpmdb_strings.migration_failed,
                get_ajax_errors(jqXHR.responseText, '(#112)', jqXHR), 'error');
            ...
            success: function (data) {
              ...
              if ('savefile' !== migration_intent && 'undefined' !== typeof wpmdb.common.connection_data && 'undefined' !== typeof wpmdb.common.connection_data.delay_between_requests) {
                delay_between_requests = Math.max(parseInt(wpmdb_data.delay_between_requests),
                  parseInt(wpmdb.common.connection_data.delay_between_requests));
              }
              ...
              wpmdb.functions.migrate_table_recursive = function (current_row, primary_keys) {
                ...
                if (i >= tables_to_migrate.length) {
                  if ('backup' === stage) {
                    ...
                    wpmdb.common.hooks = $.wpmdb.apply_filters('wpmdb_before_migration_complete_hooks',
                      wpmdb.common.hooks);
                    wpmdb.common.hooks.push(wpmdb.functions.migration_complete);
                    wpmdb.common.hooks.push(wpmdb.functions.wpmdb_flush);
                    wpmdb.common.hooks = $.wpmdb.apply_filters('wpmdb_after_migration_complete_hooks',
                      wpmdb.common.hooks);
                ...
                var gzip = 0;
                if ('savefile' !== migration_intent && 'find_replace' !== migration_intent && 1 === parseInt(
                    wpmdb.common.connection_data.gzip)) {
                  gzip = 1;
                }
                ...
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    wpmdb.current_migration.model.getStageModel(stage).setItemRowsTransferred(tables_to_migrate[i],
        ...
        wpmdb.functions.migration_complete_events = function () {
          if (false === wpmdb.common.migration_error) {
            if ('' === wpmdb.common.non_fatal_errors) {
              ...
              wpmdb.current_migration.setState(wpmdb_strings.completed_with_some_errors, wpmdb.common.non_fatal_errors,
                'error');
            }
          }
        ...
        wpmdb.functions.migration_complete = function () {
          ...
          if ('savefile' === migration_intent) {
            ...
            $.ajax({
              ...
              error: function (jqXHR, textStatus, errorThrown) {
                doing_ajax = false;
                wpmdb.current_migration.setState(wpmdb_strings.migration_failed, wpmdb_strings.finalize_tables_problem,
                  'error');
        ...
        function save_active_profile() {
          ...
          $.ajax({
            ...
            success: function (data) {
              var updated_profile_id = parseInt(
                  $('#migrate-form input[name=save_migration_profile_option]:checked').val(), 10) + 1;
              doing_ajax = false;
              $('.save-settings-button').removeAttr('disabled');
              $('.save-profile-ajax-spinner').remove();
              $('.save-settings-button').after('<span class="ajax-success-msg">' + wpmdb_strings.saved + '</span>');
              ...
              if (create_new_profile) {
                ...
                var new_li = $(
                  '<li><span class="delete-profile" data-profile-id="' + new_profile_id + '"></span><label for="profile-' + new_profile_id + '"><input id="profile-' + new_profile_id + '" value="' + new_profile_key + '" name="save_migration_profile_option" type="radio"></label></li>');
              ...
              var updated_url = window.location.href.replace('#migrate', '').replace(/&wpmdb-profile=-?\d+/,
                  '') + '&wpmdb-profile=' + updated_profile_id;
              var updated_profile_name = $(
                '#migrate-form input[name=save_migration_profile_option]:checked').parent().text().trim();
        ...
        $('.add-replace').click(function () {
          $('.replace-fields').prepend(
            $('.original-repeatable-field').clone().removeClass('original-repeatable-field'));
        ...
        $('.reset-api-key').click(function () {
          ...
          $('.reset-api-key').after(
            '<img src="' + spinner_url + '" alt="" class="reset-api-key-ajax-spinner general-spinner" />');
        ...
        $('.show-multiselect').each(function () {
          if ($(this).is(':checked')) {
            $(this).parents('.option-section').children('.header-expand-collapse').children(
              '.expand-collapse-arrow').removeClass('collapsed');
        ...
        $('.plugin-compatibility-save').click(function () {
          ...
          $(this).after(
            '<img src="' + spinner_url + '" alt="" class="plugin-compatibility-spinner general-spinner" />');
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              doing_plugin_compatibility_ajax = false;
              $('.plugin-compatibility-spinner').remove();
              $('.plugin-compatibility-save').after(
                '<span class="plugin-compatibility-success-msg">' + wpmdb_strings.saved + '</span>');
        ...
        function connection_box_changed() {
          ...
          if ($('.basic-access-auth-wrapper').is(':visible')) {
            ...
            connection_info[0] = connection_info[0].replace('//',
              '//' + encodeURIComponent($.trim($('.auth-username').val())) + ':' + encodeURIComponent(
                $.trim($('.auth-password').val())) + '@');
            new_connection_info_contents = connection_info[0] + '\n' + connection_info[1];
            $('.pull-push-connection-info').val(new_connection_info_contents);
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if ('undefined' !== typeof data.wpmdb_error && 1 === data.wpmdb_error) {
                ...
                if (!$('.pull-push-connection-info').hasClass('temp-disabled') && !$('.connect-button').is(
                    ':visible')) {
        ...
        wpmdb.functions.execute_next_step = function () {
          ...
          if (true === migration_paused) {
            ...
            $.ajax({
              ...
              data: request_data,
              error: function (jqXHR, textStatus, errorThrown) {
                wpmdb.current_migration.setState(wpmdb_strings.migration_cancellation_failed,
                  wpmdb_strings.manually_remove_temp_files + '<br /><br />' + wpmdb_strings.status + ': ' + jqXHR.status + ' ' + jqXHR.statusText + '<br /><br />' + wpmdb_strings.response + ':<br />' + jqXHR.responseText,
                  'error');
                console.log(jqXHR);
                console.log(textStatus);
                console.log(errorThrown);
          ...
          $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
              ...
              $('.invalid-licence').append(
                '<br /><br />' + wpmdb_strings.status + ': ' + jqXHR.status + ' ' + jqXHR.statusText + '<br /><br />' + wpmdb_strings.response + '<br />' + jqXHR.responseText);
              $('.ajax-spinner').remove();
              doing_ajax = false;
            },
            success: function (data) {
  ...
  }, {"MigrationProgress-controller": 1}]
}, {}, [1, 2, 3, 4, 5, 6, 7]);
