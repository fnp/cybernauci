...
<tr>
    <td><?php $this->template( 'checkbox', 'common', array( 'key'   => 'plugin-compatibility',
	                                                        'value' => $plugin_compatibility_checked
		) ); ?></td>
    <td>
        <h4>
			<?php _e( 'Plugin Compatibility Mode', 'wp-migrate-db' ); ?> <a href="#"
                                                                            class="general-helper plugin-compatibility-helper js-action-link"></a>
...
<tr class="plugin-compatibility-section">
    <td colspan="2">
        <div class="indent-wrap expandable-content plugin-compatibility-wrap select-wrap">
            <select autocomplete="off" class="multiselect" id="selected-plugins" name="selected_plugins[]"
                    multiple="multiple">
				<?php
            ...
            <a class="multiselect-deselect-all js-action-link"
               href="#"><?php _e( 'Deselect All', 'wp-migrate-db' ); ?></a>
            <span class="select-deselect-divider">/</span>
            <a class="multiselect-invert-selection js-action-link"
               href="#"><?php _e( 'Invert Selection', 'wp-migrate-db' ); ?></a>
