<div class="debug">
    ...
    <a href="<?php echo network_admin_url( $this->plugin_base . '&nonce=' . wp_create_nonce( 'wpmdb-download-log' ) . '&wpmdb-download-log=1' ); ?>"
       class="button"><?php _ex( 'Download', 'Download to your computer', 'wp-migrate-db' ); ?></a>
