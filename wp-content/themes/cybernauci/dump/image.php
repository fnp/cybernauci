        ...
        while (have_posts()) : the_post();
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <nav id="image-navigation" class="navigation image-navigation">
                    <div class="nav-links">
                        <div
                            class="nav-previous"><?php previous_image_link(false, __('Previous Image', 'cybernauci')); ?></div>
                        <div class="nav-next"><?php next_image_link(false, __('Next Image', 'cybernauci')); ?></div>
                    </div><!-- .nav-links -->
                ...
                <div class="entry-content">
                    ...
                    <div class="entry-attachment">
                        <?php
                        /**
                         * Filter the default cybernauci image attachment size.
                         *
                         * @since Cybernauci 1.0
                         *
                         * @param string $image_size Image size. Default 'large'.
                         */
                        $image_size = apply_filters('cybernauci_attachment_size', 'large');

                        echo wp_get_attachment_image(get_the_ID(), $image_size);
                        ?>

                        <?php cybernauci_excerpt('entry-caption'); ?>
                ...
                <footer class="entry-footer">
                    ...
                    if ($metadata) {
                        printf('<span class="full-size-link"><span class="screen-reader-text">%1$s </span><a href="%2$s">%3$s &times; %4$s</a></span>',
                            esc_html_x('Full size', 'Used before full size attachment link.', 'cybernauci'),
