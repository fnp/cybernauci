...
jQuery(document).ready(function () {
    ...
    if (zglosSzkoleMain.length > 0) {
        ...
        zglosSzkoleMain.find('input[type="submit"]').click(function () {
            var validate = (zglosSzkoleMain.find('form select.ninja-forms-req option:selected[value=""]').length == 0) ? true : false;
            ...
            if (zglosSzkoleMain.find('form input.ninja-forms-req[type="checkbox"]:not(:checked)').length !== 0) validate = false;
