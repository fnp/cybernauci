...
<?php } elseif ( has_category( 'dobre-praktyki' ) ) { ?>
    <div id="dobre-praktyki" class="single">
        <div class="info container-block">
            <div class="container mainblock">
                <img src="<?php bloginfo( 'template_directory' ); ?>/img/sidebanner-left-computer.png"
                     class="sidebanner sidebanner-left" alt=""/>
            ...
            <div class="dobre-praktyki-list">
                <div class="container mainblock">
                    <div class="col-xs-12 col-md-2">
                        <a title="wróć do listy" rel="bookmark"
                           href="<?php echo esc_url( get_permalink( get_page_by_title( 'Dobre praktyki' ) ) ); ?>"
                    ...
                    <div class="col-xs-12 col-md-6 col-md-offset-1">
						<?php
						while ( have_posts() ) : the_post();
							get_template_part( 'template-parts/content-dobre-praktyki', 'single' );
